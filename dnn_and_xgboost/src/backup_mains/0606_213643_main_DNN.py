...
####Namespace(b=4096, ct=True, e=5, et=None, f=16, fra=False, m='mlp_fe', mess='compare fixed emb_dims with variable ones', mt=3, ne=True, nfe=False, nm=False, ns=False, of=False, olv=False, rml=False, s=False, tdo=False, v=1, va=True, va_seed=62)