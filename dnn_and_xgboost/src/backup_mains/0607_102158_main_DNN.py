...
####Namespace(b=4096, ct=False, e=5, emb='n_vd', et=None, f=16, fra=False, m='mlp_fe', mess='comparison fixed dims and var dims', mt=3, ne=False, nfe=False, nm=False, ns=False, of=False, olv=False, opt='adagrad', rml=False, s=False, tdo=False, v=1, va=True, va_seed=62)